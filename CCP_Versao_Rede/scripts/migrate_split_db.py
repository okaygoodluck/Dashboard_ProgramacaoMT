...
# --- CONFIGURAÇÕES ---
REDE_DIR_ACC = r"I:\IT\ODCO\PROGRAMACAO_MT\1 - Sistemas da programação\Dashboard MT"
REDE_DIR_NORM = r"I:\IT\ODCO\PROGRAMACAO_MT\1 - Sistemas da programacao\Dashboard MT"
REDE_DIR = REDE_DIR_ACC if os.path.exists(REDE_DIR_ACC) else REDE_DIR_NORM
DB_ORIGINAL = os.path.join(REDE_DIR, "demanda_publica.db")

# Novos Nomes
DB_DATA = os.path.join(REDE_DIR, "ccp_data.db")
DB_APP = os.path.join(REDE_DIR, "ccp_app.db")
